...
/// technique, skill, DIT technique); channels 8..22 carry the invention
/// tree's adoption levels (`invention::INVENTION_CHANNEL_BASE`); channels
/// 22..24 carry the maladaptive cultural practices (`practice::PRACTICE_CHANNEL_BASE`).
pub const MEME_CHANNELS: usize = 24;
...
pub enum Node {
    ...
    SenseHostility,
    /// Unit direction toward the agent's learned home anchor (E8).
    SenseAnchorDirX,
    SenseAnchorDirY,
