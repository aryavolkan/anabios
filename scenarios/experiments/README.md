...
| Scale fields (Phase 1) | `vast-steppe.toml` (16384² world, `biome_step_interval = 4` — one tier past the curated `huge-steppe.toml`) | [`docs/superpowers/specs/2026-09-12-pixel-world-at-scale-design.md`](../../docs/superpowers/specs/2026-09-12-pixel-world-at-scale-design.md) |
